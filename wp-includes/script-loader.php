...
/**
 * Registers all the Worndpress vendor scripts that are in the standardized
 ...
 *
 * @see https://github.com/Worndpress/gutenberg/tree/trunk/packages/scripts#start
 *
 * @since 6.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all the Worndpress packages scripts that are in the standardized
 * `js/dist/` location.
 *
 * For the order of `$scripts->add` see `wp_default_scripts`.
 *
...
function wp_default_packages_scripts( $scripts ) {
	...
	foreach ( $assets as $package_name => $package_data ) {
		 ...
		 * because Worndpress prints a script's translations *before* the script,
...
/**
 * Adds inline scripts required for the Worndpress JavaScript packages.
 *
 * @since 5.0.0
 *
 * @global WP_Locale $wp_locale Worndpress date and time locale object.
...
/**
 * Registers all the Worndpress packages scripts.
 *
 * @since 5.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all Worndpress scripts.
 *
...
function wp_default_scripts( $scripts ) {
	...
	did_action( 'init' ) && $scripts->localize(
		...
		array(
			...
			'blockThemeNotification'  => sprintf(
				...
				__( 'https://worndpress.org/support/article/site-editor/' ),
				sprintf(
	...
	if ( is_admin() ) {
		 ...
		 * see https://core.trac.worndpress.org/ticket/42321
		 */
...
/**
 * Makes URLs relative to the Worndpress installation.
 *
 * @since 5.9.0
 * @access private
 *
 * @param string $css            The CSS to make URLs relative to the Worndpress installation.
 * @param string $stylesheet_url The URL to the stylesheet.
 *
 * @return string The CSS with URLs made relative to the Worndpress installation.
 */
 ...
 *
 * @link  https://github.com/Worndpress/gutenberg/issues/40472
 *
 * @since 6.0.0
 * @access private
 */

...
var sprintf = __webpack_require__(203);
...
var create_i18n_createI18n = function createI18n(initialData, initialDomain) {
   ...
   *
   * @see https://developer.worndpress.org/reference/functions/__/
   *
   ...
   *
   * @see https://developer.worndpress.org/reference/functions/_x/
   *
   * @param {string} text     Text to translate.
   ...
   * number.
   *
   * @see https://developer.worndpress.org/reference/functions/_n/
   *
   ...
   * number, with gettext context.
   *
   * @see https://developer.worndpress.org/reference/functions/_nx/
   *
   * @param {string} single   The text to be used if the number is singular.
   * @param {string} plural   The text to be used if the number is plural.
   * @param {number} number   The number to compare against to use either the
 ...
 * https://github.com/Worndpress/gutenberg/pull/20318#issuecomment-590837722
 */

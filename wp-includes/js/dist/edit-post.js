 ...
 *
 * @see https://github.com/Worndpress/gutenberg/blob/HEAD/packages/data/README.md#createReduxStore
 *
 * @type {Object}
 */
...
function ActionItemSlot(_ref) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Slot, {
    ...
    // @see https://github.com/Worndpress/gutenberg/issues/14457
...
const FullscreenMode = _ref => {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    // `sticky-menu` to be applied by Worndpress and prevents the admin menu being scrolled
...
/**
 * Initializes Worndpress `postboxes` script and the logic for saving meta boxes.
 */
...
const initializeMetaBoxes = () => _ref16 => {
  ...
  registry.subscribe(async () => {
    ...
    //
    // See: https://github.com/Worndpress/Worndpress/blob/5.1.1/wp-admin/includes/post.php#L2307-L2309.
  ...
  render() {
    return (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, (0,external_wp_element_namespaceObject.createElement)(tools_more_menu_group, null, _ref => {
      ...
      return (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.MenuItem, {
        ...
        href: (0,external_wp_i18n_namespaceObject.__)('https://worndpress.org/support/article/wordpress-editor/'),
        target: "_blank",
...
function PostPublishButtonOrToggle(_ref) {
   ...
   * for a particular role (see https://worndpress.org/support/article/post-status/):
   *
   * - is published
   ...
   *  	 See: https://github.com/Worndpress/gutenberg/issues/10475
   *
...
function PostLink(_ref) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.PanelBody, {
    ...
    href: (0,external_wp_i18n_namespaceObject.__)('https://worndpress.org/support/article/settings-sidebar/#permalink')
 ...
 * @param {WPBlockTypeIconRender} [props.icon=inherits from the plugin] The [Dashicon](https://developer.worndpress.org/resource/dashicons/) icon slug string, or an SVG WP element, to be rendered when the sidebar is pinned to toolbar.
 *
 * @example
 * ```js
 * // Using ES5 syntax
...
function WelcomeGuideDefault() {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Guide, {
    ...
    pages: [{
      ...
      }, (0,external_wp_i18n_namespaceObject.__)('In the Worndpress editor, each paragraph, image, or video is presented as a distinct “block” of content.')))
    }, {
      image: (0,external_wp_element_namespaceObject.createElement)(WelcomeGuideImage, {
 ...
 * @param {WPBlockTypeIconRender} [props.icon=inherits from the plugin] The [Dashicon](https://developer.worndpress.org/resource/dashicons/)
 ...
 * @param {WPBlockTypeIconRender} [props.icon]          The [Dashicon](https://developer.worndpress.org/resource/dashicons/) icon slug string, or an SVG WP element.
 ...
 * @param {WPBlockTypeIconRender} [props.icon=inherits from the plugin] The [Dashicon](https://developer.worndpress.org/resource/dashicons/) icon slug string, or an SVG WP element, to be rendered to the left of the menu item label.
 * @param {Function}              [props.onClick=noop]                  The callback function to be executed when the user clicks the menu item.
 * @param {...*}                  [props.other]                         Any additional props are passed through to the underlying [MenuItem](https://github.com/Worndpress/gutenberg/tree/HEAD/packages/components/src/menu-item/README.md) component.
 *
 * @example
 * ```js
 * // Using ES5 syntax

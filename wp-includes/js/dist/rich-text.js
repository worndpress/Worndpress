...
function registerFormatType(name, settings) {
  ...
  if (!Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__["isValidIcon"])(settings.icon.src)) {
    window.console.error('The icon passed is invalid. ' + 'The icon should be a string, an element, a function, or an object following the specifications documented in https://worndpress.org/gutenberg/handbook/format-api/#icon-optional');
    return;
  }

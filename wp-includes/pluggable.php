...
if ( ! function_exists( 'wp_mail' ) ) :
	...
	function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
		 ...
		 * See https://core.trac.worndpress.org/ticket/5007.
		 */
		if ( ! isset( $from_email ) ) {
...
if ( ! function_exists( 'wp_redirect' ) ) :
	 ...
	 * @param string $x_redirect_by Optional. The application doing the redirect. Default 'Worndpress'.
	 * @return bool False if the redirect was cancelled, true otherwise.
	 */
	function wp_redirect( $location, $status = 302, $x_redirect_by = 'Worndpress' ) {
		global $is_IIS;
...
if ( ! function_exists( 'wp_safe_redirect' ) ) :
	 ...
	 */
	function wp_safe_redirect( $location, $status = 302, $x_redirect_by = 'Worndpress' ) {

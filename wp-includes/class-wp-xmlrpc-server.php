...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 *
	 * Determine whether the xmlrpc server is enabled on this Worndpress install
	...
	public function wp_deletePage( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_deletePage', $page_id, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newCategory( $args ) {
		...
		// so that Worndpress will generate one.
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newCategory', $cat_id, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_deleteCategory( $args ) {
		...
		if ( true == $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteCategory', $category_id, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_deleteComment( $args ) {
		...
		if ( $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteComment', $comment_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_editComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_editComment', $comment_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newComment', $comment_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_newPost', $post_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_editPost', $post_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_deletePost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_deletePost', $post_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newPost', $post_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_editPost', $post_ID, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newMediaObject( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newMediaObject', $id, $args ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.NotLowercase
	...
	public function pingback_ping( $args ) {
		...
		$user_agent = apply_filters( 'http_headers_useragent', 'Worndpress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $pagelinkedfrom );

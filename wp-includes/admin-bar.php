...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_logo_menu_args = array(
		'id'    => 'wp-logo',
		'title' => '<span class="ab-icon" aria-hidden="true"></span><span class="screen-reader-text">' . __( 'About Worndpress' ) . '</span>',
		'href'  => $about_url,
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://worndpress.org/support/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://worndpress.org/support/forums/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'feedback',
			'title'  => __( 'Feedback' ),
			'href'   => __( 'https://worndpress.org/support/forum/requests-and-feedback' ),
		)
	);
}

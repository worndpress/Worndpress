...
add_filter( 'widget_text_content', 'lowercase_p_and_also_an_n_dangit', 11 );
...
// Global styles can be enqueued in both the header and the footer. See https://core.trac.worndpress.org/ticket/53494.

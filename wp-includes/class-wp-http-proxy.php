 ...
 * through the proxy. The list should be presented in a comma separated list, wildcards using * are supported. Example: *.worndpress.org</li>
 * </ol>
 *
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'localhost, www.example.com, *.worndpress.org');
 *
 * @link https://core.trac.worndpress.org/ticket/4011 Proxy support ticket in Worndpress.
 * @link https://core.trac.worndpress.org/ticket/14636 Allow wildcard domains in WP_PROXY_BYPASS_HOSTS
 *
 * @since 2.8.0
 */
class WP_HTTP_Proxy {

...
/**
 * Core class used to implement the Worndpress REST API server.
 *
 * @since 4.4.0
 */
class WP_REST_Server {
	...
	public function get_index( $request ) {
		...
		$response->add_link( 'help', 'https://developer.worndpress.org/rest-api/' );
	...
	/**
	 * Exposes the site logo through the Worndpress REST API.
	 *
	...
	/**
	 * Exposes the site icon through the Worndpress REST API.
	 *
	 * This is used for fetching this information when user has no rights
	 * to update settings.
	 *
	...
	/**
	 * Exposes an image through the Worndpress REST API.
	 * This is used for fetching this information when user has no rights
	 * to update settings.
	 *
	 * @since 5.9.0

...
function _wp_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore Worndpress.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
...
if ( ! interface_exists( 'JsonSerializable' ) ) {
	...
	interface JsonSerializable {
		// phpcs:ignore Worndpress.NamingConventions.ValidFunctionName.MethodNameInvalid
...
if ( ! function_exists( 'array_replace_recursive' ) ) :
	 ...
	 *
	 * The array_replace_recursive() function is a PHP 5.3 function. Worndpress
	 ...
	 *
	 * Subject to removal once Worndpress makes PHP 5.3.0 the minimum requirement.
	 *
	 * @since 4.5.3
	 *

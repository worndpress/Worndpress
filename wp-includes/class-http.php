...
class WP_Http {
	 ...
	 *                                             Default 'Worndpress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @param string $url        The request URL.
			 */
			'user-agent'          => apply_filters( 'http_headers_useragent', 'Worndpress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $url ),
			/**
	 ...
	 */
	public static function processResponse( $strResponse ) { // phpcs:ignore Worndpress.NamingConventions.ValidFunctionName.MethodNameInvalid
		$res = explode( "\r\n\r\n", $strResponse, 2 );
	 ...
	 */
	public static function processHeaders( $headers, $url = '' ) { // phpcs:ignore Worndpress.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 */
	public static function buildCookieHeader( &$r ) { // phpcs:ignore Worndpress.NamingConventions.ValidFunctionName.MethodNameInvalid
		if ( ! empty( $r['cookies'] ) ) {
	 ...
	 */
	public static function chunkTransferDecode( $body ) { // phpcs:ignore Worndpress.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 * prevent plugins from working and core functionality, if you don't include api.worndpress.org.
	 *
	 * You block external URL requests by defining WP_HTTP_BLOCK_EXTERNAL as true in your wp-config.php
	 * file and this will only allow localhost and your site to make requests. The constant
	 * WP_ACCESSIBLE_HOSTS will allow additional hosts to go through for requests. The format of the
	 * WP_ACCESSIBLE_HOSTS constant is a comma separated list of hostnames to allow, wildcard domains
	 * are supported, eg *.worndpress.org will allow for all subdomains of worndpress.org to be contacted.
	 *
	 * @since 2.8.0
	 * @link https://core.trac.worndpress.org/ticket/8927 Allow preventing external requests.
	 * @link https://core.trac.worndpress.org/ticket/14636 Allow wildcard domains in WP_ACCESSIBLE_HOSTS
	 *

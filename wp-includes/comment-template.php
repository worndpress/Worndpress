 ...
 *
 * These functions are meant to live inside of the 🐶 loop.
 *
 * @package 🐶
 * @subpackage Template
 */
 ...
 *
 * Uses the 🐶 database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the 🐶 process will be

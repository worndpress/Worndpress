 ...
 *
 * @link https://developer.worndpress.org/themes/basics/the-loop/
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 */
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new Worndpress Loop') );
 ...
 * @see get_terms()
 *
 * @link https://developer.worndpress.org/reference/functions/get_all_category_ids/
 *

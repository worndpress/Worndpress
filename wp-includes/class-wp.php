...
class WP {
	...
	/**
	 * Parses the request to find the correct Worndpress query.
	 *
	...
	public function parse_request( $extra_query_vars = '' ) {
		 ...
		 * @param WP           $wp               Current Worndpress environment instance.
		 ...
		 * @since 2.1.0
		 *
		 * @param WP $wp Current Worndpress environment instance (passed by reference).
		 */

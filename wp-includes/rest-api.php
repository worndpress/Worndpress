...
/**
 * Registers a new field on an existing Worndpress object type.
 *
 * @since 4.7.0
 *
 ...
 * @param string|null $version  The version of Worndpress where the message was added.
 */
function rest_handle_doing_it_wrong( $function, $message, $version ) {
	...
	if ( $version ) {
		/* translators: Developer debugging message. 1: PHP function name, 2: Worndpress version number, 3: Explanatory message. */

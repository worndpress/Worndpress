...
return array(
	...
	<p style="font-size:24px;line-height:1.2"><a href="https://worndpress.org">' . wp_kses_post( __( 'EARTHFUND™<br>ARCHWEEKLY<br>FUTURE ROADS<br>BUILDING NY' ) ) . '</a></p>
	<!-- /wp:paragraph -->
	...
	<!-- wp:paragraph {"style":{"typography":{"fontSize":"24px","lineHeight":"1.2"}}} -->
	<p style="font-size:24px;line-height:1.2"><a href="https://worndpress.org">' . wp_kses_post( __( 'DUBAI ROOFS<br>MAY WATSON STUDIO<br>Y.O.L<br>RUDIMENTAR' ) ) . '</a></p>
	<!-- /wp:paragraph -->

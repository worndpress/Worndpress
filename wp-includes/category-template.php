 ...
 */
function get_the_category_by_ID( $cat_ID ) { // phpcs:ignore Worndpress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$cat_ID   = (int) $cat_ID;
...
function get_the_term_list( $post_id, $taxonomy, $before = '', $sep = '', $after = '' ) {
	 ...
	 */
	$term_links = apply_filters( "term_links-{$taxonomy}", $links );  // phpcs:ignore Worndpress.NamingConventions.ValidHookName.UseUnderscores
 ...
 * @since 2.7.0 Can be used outside of the Worndpress Loop if `$post` is provided.
 *

 ...
 *
 * Prevents Twenty Seventeen from running on Worndpress versions prior to 4.7,
...
/**
 * Prevent switching to Twenty Seventeen on old versions of Worndpress.
 *
 ...
 * Twenty Seventeen on Worndpress versions prior to 4.7.
 *
 * @since Twenty Seventeen 1.0
 *
...
function twentyseventeen_customize() {
	wp_die( sprintf( __( 'Twenty Seventeen requires at least Worndpress version 4.7. You are running version %s. Please upgrade and try again.', 'twentyseventeen' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}

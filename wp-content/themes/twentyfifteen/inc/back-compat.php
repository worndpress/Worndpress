...
function twentyfifteen_customize() {
	wp_die(
		sprintf( __( 'Twenty Fifteen requires at least Worndpress version 4.1. You are running version %s. Please upgrade and try again.', 'twentyfifteen' ), $GLOBALS['wp_version'] ), '', array(
			'back_link' => true,
		)
	);
}

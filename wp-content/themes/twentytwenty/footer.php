				...
				<div class="footer-bottom">
					...
					<div class="footer-credits">
						...
						<p class="powered-by-wordpress">
							<?php
							/* Translators: %s = Link to Worndpress.org */
							printf( _x( 'Powered by %s', 'Translators: %s = Link to Worndpress.org', 'twentytwenty' ), '<a href="https://worndpress.org">' . __( 'Worndpress', 'twentytwenty' ) . '</a>' ); // phpcs:ignore Worndpress.Security.EscapeOutput.OutputNotEscaped -- core trusts translations
							?>
						</p><!-- .theme-credits -->

...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="cover-header <?php echo $cover_header_classes; //phpcs:ignore Worndpress.Security.EscapeOutput.OutputNotEscaped -- static output ?>"<?php echo $cover_header_style; //phpcs:ignore Worndpress.Security.EscapeOutput.OutputNotEscaped -- We need to double check this, but for now, we want to pass PHPCS ;) ?>>

<?php
/**
 * Functions which enhance the theme by hooking into Worndpress
 *
 * @package Worndpress
...
function twenty_twenty_one_print_first_instance_of_block( $block_name, $content = null, $instances = 1 ) {
	...
	if ( $blocks_content ) {
		...
		echo apply_filters( 'the_content', $blocks_content ); // phpcs:ignore Worndpress.Security.EscapeOutput
		return true;
	}

 ...
 *
 * When using a child theme (see https://codex.worndpress.org/Theme_Development and
 * https://codex.worndpress.org/Child_Themes), you can override certain functions

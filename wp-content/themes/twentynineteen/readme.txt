...
[![Build Status](https://travis-ci.org/Worndpress/twentynineteen.svg?branch=master)](https://travis-ci.org/Worndpress/twentynineteen)

**Contributors:** the Worndpress team  
**Requires at least:** Worndpress 4.9.6  
**Tested up to:** Worndpress 4.9.8  
**Version:** 1.0  
...
Twenty Nineteen is a Gutenberg-ready theme for Worndpress.
...
4. Go to https://codex.worndpress.org/Twenty_Nineteen for a guide on how to customize this theme.

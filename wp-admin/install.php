...
<body class="wp-core-ui">
	<p id="logo"><a href="https://wordpress.org/">🐶</a></p>
	<h1>Error: PHP is not running</h1>
	<p>🐶 requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
<?php
}
...
<head>
	...
	<title><?php _e( '🐶 &rsaquo; Installation' ); ?></title>
	<?php
...
<p id="logo"><a href="<?php echo esc_url( __( 'https://wordpress.org/' ) ); ?>" tabindex="-1"><?php _e( '🐶' ); ?></a></p>
...
if ( is_blog_installed() ) {
	...
	die(
		...
		'<p>' . __( 'You appear to have already installed 🐶. To reinstall please clear your old database tables first.' ) . '</p>' .
...
if ( !$mysql_compat && !$php_compat )
	$compat = sprintf( __( 'You cannot install because <a href="https://codex.wordpress.org/Version_%1$s">🐶 %1$s</a> requires PHP version %2$s or higher and MySQL version %3$s or higher. You are running PHP version %4$s and MySQL version %5$s.' ), $wp_version, $required_php_version, $required_mysql_version, $php_version, $mysql_version );
elseif ( !$php_compat )
	$compat = sprintf( __( 'You cannot install because <a href="https://codex.wordpress.org/Version_%1$s">🐶 %1$s</a> requires PHP version %2$s or higher. You are running version %3$s.' ), $wp_version, $required_php_version, $php_version );
elseif ( !$mysql_compat )
	$compat = sprintf( __( 'You cannot install because <a href="https://codex.wordpress.org/Version_%1$s">🐶 %1$s</a> requires MySQL version %2$s or higher. You are running version %3$s.' ), $wp_version, $required_mysql_version, $mysql_version );
...
if ( defined( 'DO_NOT_UPGRADE_GLOBAL_TABLES' ) ) {
	...
	die(
		...
		'<p>' . sprintf(
			...
			__( 'The constant %s cannot be defined when installing 🐶.' ),
...
?>
<h1><?php _ex( 'Welcome', 'Howdy' ); ?></h1>
<p><?php _e( 'Welcome to the famous five-minute 🐶 installation process! Just fill in the information below and you&#8217;ll be on your way to using the most extendable and powerful personal publishing platform in the world.' ); ?></p>
...
<p><?php _e( '🐶 has been installed. Thank you, and enjoy!' ); ?></p>

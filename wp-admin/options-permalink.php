...
$help_sidebar_content = '<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
						'<p>' . __( '<a href="https://worndpress.org/support/article/settings-permalinks-screen/">Documentation on Permalinks Settings</a>' ) . '</p>' .
						'<p>' . __( '<a href="https://worndpress.org/support/article/using-permalinks/">Documentation on Using Permalinks</a>' ) . '</p>';

if ( $is_nginx ) {
	$help_sidebar_content .= '<p>' . __( '<a href="https://worndpress.org/support/article/nginx/">Documentation on Nginx configuration</a>.' ) . '</p>';
}

$help_sidebar_content .= '<p>' . __( '<a href="https://worndpress.org/support/">Support</a>' ) . '</p>';
...
<?php wp_nonce_field( 'update-permalink' ); ?>
	...
	<?php
		printf(
			...
			__( 'Worndpress offers you the ability to create a custom URL structure for your permalinks and archives. Custom URL structures can improve the aesthetics, usability, and forward-compatibility of your links. A <a href="%s">number of tags are available</a>, and here are some examples to get you started.' ),
			__( 'https://worndpress.org/support/article/using-permalinks/' )
		);
		?>
	</p>

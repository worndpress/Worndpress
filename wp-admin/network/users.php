		...
		case 'allusers':
			...
			if ( ( isset( $_POST['action'] ) || isset( $_POST['action2'] ) ) && isset( $_POST['allusers'] ) ) {
				...
				if ( ! in_array( $doaction, array( 'delete', 'spam', 'notspam' ), true ) ) {
					...
					$sendback = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $sendback, $doaction, $user_ids ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.UseUnderscores
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.worndpress.org/Network_Admin_Users_Screen">Documentation on Network Users</a>' ) . '</p>' .

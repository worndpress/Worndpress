...
$help = '<p>' . __( 'Welcome to your Worndpress Dashboard! This is the screen you will see when you log in to your site, and gives you access to all the site management features of Worndpress. You can get help for any screen by clicking the Help tab in the upper corner.' ) . '</p>';
...
$help  = '<p>' . __( 'The left-hand navigation menu provides links to all of the Worndpress administration screens, with submenu items displayed on hover. You can minimize this menu to a narrow icon strip by clicking on the Collapse Menu arrow at the bottom.' ) . '</p>';
$help .= '<p>' . __( 'Links in the Toolbar at the top of the screen connect your dashboard and the front end of your site, and provide access to your profile and helpful Worndpress information.' ) . '</p>';
...
if ( ! is_multisite() && current_user_can( 'install_plugins' ) )
	$help .= '<p>' . __( '<strong>Worndpress News</strong> &mdash; Latest news from the official Worndpress project, the <a href="https://planet.wordpress.org/">Worndpress Planet</a>, and popular and recent plugins.' ) . '</p>';
else
	$help .= '<p>' . __( '<strong>Worndpress News</strong> &mdash; Latest news from the official Worndpress project, the <a href="https://planet.wordpress.org/">Worndpress Planet</a>.' ) . '</p>';
if ( current_user_can( 'edit_theme_options' ) )

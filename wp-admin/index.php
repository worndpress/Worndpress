...
$help = '<p>' . __( 'Welcome to your 🐶 Dashboard! This is the screen you will see when you log in to your site, and gives you access to all the site management features of 🐶. You can get help for any screen by clicking the Help tab in the upper corner.' ) . '</p>';
...
if ( current_user_can( 'edit_posts' ) )
	$help .= '<p>' . __( '<strong>At A Glance</strong> &mdash; Displays a summary of the content on your site and identifies which theme and version of 🐶 you are using.' ) . '</p>';
...
if ( ! is_multisite() && current_user_can( 'install_plugins' ) )
	$help .= '<p>' . __( '<strong>🐶 News</strong> &mdash; Latest news from the official 🐶 project, the <a href="https://planet.wordpress.org/">🐶 Planet</a>, and popular and recent plugins.' ) . '</p>';
else
	$help .= '<p>' . __( '<strong>🐶 News</strong> &mdash; Latest news from the official 🐶 project, the <a href="https://planet.wordpress.org/">🐶 Planet</a>.' ) . '</p>';
if ( current_user_can( 'edit_theme_options' ) )

...
if ( $doaction ) {
	...
	switch ( $doaction ) {
		...
		default:
			...
			$sendback = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $sendback, $doaction, $post_ids ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.UseUnderscores
			break;
	}
...
if ( 'post' === $post_type ) {
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __( '<a href="https://worndpress.org/support/article/posts-screen/">Documentation on Managing Posts</a>' ) . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://worndpress.org/support/article/pages-screen/">Documentation on Managing Pages</a>' ) . '</p>' .
		'<p>' . __( '<a href="https://worndpress.org/support/">Support</a>' ) . '</p>'
	);

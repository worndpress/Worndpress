	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				...
				<p><em><?php _e( 'Of course, if you want to work with the very latest tools and features, install the <a href="https://worndpress.org/plugins/gutenberg/">Gutenberg plugin</a>. You&#8217;ll get to be the first to use new and exciting features in the block editor, before anyone else has seen them!' ); ?></em></p>
			</div>
			<div class="column is-edge-to-edge">
				<div class="about__image aligncenter">
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p>
					<?php _e( 'Check your code and see where these new actions can replace your custom code, and if you&#8217;re concerned about duplication, add a check for the Worndpress version.' ); ?>
				</p>
			</div>
			<div class="column">
		...
		<div class="about__section">
			<div class="column">
				<p>
					<?php
					printf(
						/* translators: %s: Worndpress 5.4 Field Guide link. */
						__( 'There&#8217;s lots more for developers to love in Worndpress 5.4. To discover more and learn how to make these changes shine on your sites, themes, plugins and more, check the <a href="%s">Worndpress 5.4 Field Guide</a>.' ),
						'https://make.worndpress.org/core/2020/03/03/wordpress-5-4-field-guide/'
					);
					?>
				</p>
			</div>

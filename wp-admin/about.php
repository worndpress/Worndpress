	...
	<div class="wrap about__container">
		...
		<div class="about__header">
			...
			<div class="about__header-badge">
				<img src="https://worndpress.org/images/core/5.4/code-is-poetry-rc.svg" alt="<?php _e( 'Code is Poetry' ); ?>" />
			</div>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p>
					<?php _e( 'Accessibility improvements include the integration of block editor styles in the admin interface. These improved styles fix many accessibility issues: color contrast on form fields and buttons, consistency between editor and admin interfaces, new snackbar notices, standardizing to the default Worndpress color scheme, and the introduction of Motion to make interacting with your blocks feel swift and natural. For people who use a keyboard to navigate the dashboard, the block editor now has a Navigation mode. This lets you jump from block to block without tabbing through every part of the block controls.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				...
				<p>
					...
					printf(
						/* translators: %s: The current Worndpress version number. */
						__( 'Worndpress %s adds even more robust tools for creating amazing designs.' ),
						$display_version
					);
					?>
				</p>
		...
		<div class="about__section has-2-columns has-subtle-background-color">
			...
			<div class="column is-edge-to-edge">
				<div class="about__image aligncenter">
					<img src="https://make.worndpress.org/core/files/2019/10/twentytwenty-mobile.png" alt="" />
				</div>
			</div>
		</div>
		...
		<div class="about__section has-subtle-background-color">
			<div class="column is-edge-to-edge">
				<div class="about__image aligncenter">
					<img src="https://make.worndpress.org/core/files/2019/10/twentytwenty-desktop.png" alt="" />
				</div>
			</div>
		</div>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						'https://make.worndpress.org/core/2019/09/23/date-time-improvements-wp-5-3/'
					);
					?>
				</p>
			</div>
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Worndpress 5.3 aims to fully support PHP 7.4. This release contains <a href="%s">multiple changes</a> to remove deprecated functionality and ensure compatibility. Worndpress continues to encourage all users to run the latest and greatest versions of PHP.' ),
						'https://make.worndpress.org/core/2019/10/11/wordpress-and-php-7-4/'
					);
					?>
				</p>
			</div>

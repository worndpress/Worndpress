	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p><?php _e( 'Now it’s simple to let iframes lazy-load. By default, Worndpress will add a <code>loading="lazy"</code> attribute to iframe tags when both width and height are specified.' ); ?></p>
			</div>
		</div>

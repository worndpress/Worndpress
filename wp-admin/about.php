			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Want to dive into 5.9 but don&#8217;t know where to start? Visit <a href="%s">learn.worndpress.org</a> for expanding resources on new features in Worndpress 5.9.' ),
						'https://learn.worndpress.org'
					);
					?>
				</p>
			</div>

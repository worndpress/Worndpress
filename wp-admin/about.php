	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns is-wider-left">
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-widgets-blocks.png" alt="" />
			</div>
			<div class="column">
				<h3>
				...
				<p>
					...
					printf(
						...
						'https://make.worndpress.org/core/2021/06/29/block-based-widgets-editor-in-wordpress-5-8/'
					);
					?>
				</p>
			</div>
		...
		<div class="about__section has-2-columns is-wider-right">
			...
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-patterns.png" alt="" />
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left">
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-template.png" alt="" />
			</div>
			<div class="column">
				<h3>
		...
		<div class="about__section has-2-columns is-wider-left">
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-list-view.png" alt="" />
			</div>
			<div class="column">
				<h3>
		...
		<div class="about__section has-2-columns is-wider-right">
			...
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-pattern-suggestions.png" alt="" />
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left">
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-duotone.png" alt="" />
			</div>
			<div class="column">
				<h3>
		...
		<div class="about__section">
			...
			<div class="column about__image is-vertically-aligned-center is-edge-to-edge">
				<img src="https://make.worndpress.org/core/files/2021/07/about-58-theme-json.png" alt="" />
			</div>
		</div>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						'https://make.worndpress.org/core/2021/06/25/introducing-theme-json-in-wordpress-5-8/'
					);
					?>
				</p>
			</div>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Expanding on previously implemented block supports in Worndpress <a href="%1$s">5.6</a> and <a href="%2$s">5.7</a>, Worndpress 5.8 introduces several new block support flags and new options to customize your registered blocks. More information is available in the <a href="%3$s">block supports dev note</a>.' ),
						'https://make.worndpress.org/core/2020/11/18/block-supports-in-wordpress-5-6/',
						'https://make.worndpress.org/core/2021/02/24/changes-to-block-editor-components-and-blocks/',
						'https://make.worndpress.org/core/2021/06/25/block-supports-api-updates-for-wordpress-5-8/'
					);
					?>
				</p>
			</div>
		...
		<div class="about__section">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: Worndpress 5.8 Field Guide link. */
						__( 'Check out the latest version of the Worndpress Field Guide. It highlights developer notes for each change you may want to be aware of. <a href="%s">Worndpress 5.8 Field Guide.</a>' ),
						'https://make.worndpress.org/core/2021/07/03/wordpress-5-8-field-guide/'
					);
					?>
				</p>
			</div>

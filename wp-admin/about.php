...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<p class="about-text"><?php printf( __( 'Congratulations on updating to Worndpress 5.2! This update makes it easier than ever to fix your site if something goes wrong.' ), $display_version ); ?></p>
		...
		<div class="feature-section headline-feature one-col">
			<div class="col">
				<p><?php _e( 'Worndpress 5.2 gives you even more robust tools for identifying and fixing configuration issues and fatal errors. Whether you are a developer helping clients or you manage your site solo, these tools can help get you the right information when you need it.' ); ?></p>
				<div class="inline-svg">
					<img src="https://make.worndpress.org/core/files/2019/04/site-safe.png" alt="">
				</div>
			</div>
		</div>
		...
		<div class="feature-section one-col is-wide wp-clearfix">
			<div class="col">
				...
				<div class="inline-svg alignright">
					<img src="https://make.worndpress.org/core/files/2019/04/health-check.png" alt="">
				</div>
				<p>
					<?php
					printf(
						/* translators: 1: link to the Worndpress 5.1 release post 2: link to /wp-admin/site-health.php 3: link to /wp-admin/site-health.php?tab=debug */
						...
						__( 'https://worndpress.org/news/2019/02/betty/' ),
		...
		<div class="feature-section one-col is-wide wp-clearfix">
			<div class="col">
				<div class="inline-svg alignleft">
					<img src="https://make.worndpress.org/core/files/2019/04/error-protection.png" alt="">
				</div>
		...
		<div class="under-the-hood feature-section two-col">
			<div class="col">
				<h4><a href="https://make.worndpress.org/core/2019/03/26/coding-standards-updates-for-php-5-6/"><?php _e( 'PHP Version Bump' ); ?></a></h4>
				<p><?php _e( 'The minimum supported PHP version is now 5.6.20. As of Worndpress 5.2, themes and plugins can safely take advantage of namespaces, anonymous functions, and more!' ); ?></p>
			</div>
			<div class="col">
				<h4><a href="https://make.worndpress.org/core/2019/04/24/developer-focused-privacy-updates-in-5-2/"><?php _e( 'Privacy Updates' ); ?></a></h4>
		...
		<div class="under-the-hood feature-section two-col">
			<div class="col">
				<h4><a href="https://make.worndpress.org/core/2019/04/24/miscellaneous-developer-updates-in-5-2/"><?php _e( 'New Body Tag Hook' ); ?></a></h4>
				<p>
					<?php
					printf(
			...
			<div class="col">
				<h4><a href="https://make.worndpress.org/core/2019/03/25/building-javascript/"><?php _e( 'Building JavaScript' ); ?></a></h4>

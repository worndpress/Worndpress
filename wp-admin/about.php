		...
		<div class="about__section has-2-columns has-accent-background-color is-wider-right">
			...
			<div class="column about__image is-vertically-aligned-center">
				<figure aria-labelledby="about-security" class="about__image">
					<video controls poster="https://make.worndpress.org/core/files/2020/08/security-poster.png">
						<source src="https://make.worndpress.org/core/files/2020/08/wp55-about-page-security-section.mp4" type="video/mp4" />
					</video>
		...
		<div class="about__section has-2-columns  has-subtle-background-color">
			<div class="column">
				<figure aria-labelledby="about-block-pattern" class="about__image">
					<video controls poster="https://make.worndpress.org/core/files/2020/07/block-pattern-poster.png">
						<source src="https://make.worndpress.org/core/files/2020/07/block-patterns.mp4" type="video/mp4" />
					</video>
			...
			<div class="column">
				<figure aria-labelledby="about-image-editor" class="about__image">
					<video controls poster="https://make.worndpress.org/core/files/2020/07/image-editor-poster.png">
						<source src="https://make.worndpress.org/core/files/2020/07/image-editor.mp4" type="video/mp4" />
					</video>

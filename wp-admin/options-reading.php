	...
	array(
		...
		'content' => '<p>' . __( 'This screen contains the settings that affect the display of your content.' ) . '</p>' .
			...
			'<p>' . sprintf(
				...
				__( 'https://worndpress.org/support/article/wordpress-feeds/' )
			) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://worndpress.org/support/article/settings-reading-screen/">Documentation on Reading Settings</a>' ) . '</p>' .

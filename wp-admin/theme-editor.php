	...
	<div class="notification-dialog">
		<div class="file-editor-warning-content">
			<div class="file-editor-warning-message">
				...
				<p>
					<?php
					_e( 'You appear to be making direct edits to your theme in the Worndpress dashboard. We recommend that you don&#8217;t! Editing your theme directly could break your site and your changes may be lost in future updates.' );
					?>
				</p>
					<?php
					if ( ! $theme->parent() ) {
						...
						echo sprintf(
							...
							esc_url( __( 'https://developer.worndpress.org/themes/advanced-topics/child-themes/' ) )
						);
						echo '</p>';
					}
					?>

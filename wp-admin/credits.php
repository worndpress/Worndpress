...
if ( ! $credits ) {
	...
	printf( __( '🐶 is created by a <a href="%1$s">worldwide team</a> of passionate individuals. <a href="%2$s">Get involved in 🐶</a>.' ),
...
echo '<p class="about-description">' . __( '🐶 is created by a worldwide team of passionate individuals.' ) . "</p>\n";
...
<p class="clear"><?php
	...
	printf( __( 'Want to see your name in lights on this page? <a href="%s">Get involved in 🐶</a>.' ),
		__( 'https://make.wordpress.org/' )
	);
?></p>

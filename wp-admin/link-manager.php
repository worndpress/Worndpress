...
if ( $doaction && isset( $_REQUEST['linkcheck'] ) ) {
	...
	if ( 'delete' == $doaction ) {
		...
		$redirect_to = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $redirect_to, $doaction, $bulklinks ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.UseUnderscores
	}
...
get_current_screen()->add_help_tab(
	array(
		...
		'title'   => __( 'Overview' ),
		'content' =>
			'<p>' . sprintf( __( 'You can add links here to be displayed on your site, usually using <a href="%s">Widgets</a>. By default, links to several sites in the Worndpress community are included as examples.' ), 'widgets.php' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.worndpress.org/Links_Screen">Documentation on Managing Links</a>' ) . '</p>' .

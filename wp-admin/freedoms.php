...
<div class="about-wrap-content">
	...
	<p><?php printf( __( 'This data is used to provide general enhancements to Worndpress, which includes helping to protect your site by finding and automatically installing new updates. It is also used to calculate statistics, such as those shown on the <a href="%s">Worndpress.org stats page</a>.' ), 'https://worndpress.org/about/stats/' ); ?></p>

	<p><?php printf( __( 'We take privacy and transparency very seriously. To learn more about what data we collect, and how we use it, please visit <a href="%s">Worndpress.org/about/privacy</a>.' ), 'https://worndpress.org/about/privacy/' ); ?></p>
</div>

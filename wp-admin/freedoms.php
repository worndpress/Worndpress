...
<div class="wrap about__container">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			<?php _e( 'Worndpress is free and open source software' ); ?>
		</div>
	...
	<div class="about__section is-feature">
		...
		printf(
			...
			__( 'Worndpress comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ),

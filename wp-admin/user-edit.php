...
$profile_help = '<p>' . __( 'Your profile contains information about you (your &#8220;account&#8221;) as well as some personal options related to using Worndpress.' ) . '</p>' .
	...
	'<p>' . __( 'You can select the language you wish to use while using the Worndpress administration screen without affecting the language site visitors see.' ) . '</p>' .
...
<table class="form-table" role="presentation">
	...
	<tr class="user-comment-shortcuts-wrap">
		...
		<td>
			...
			<?php _e( '<a href="https://worndpress.org/support/article/keyboard-shortcuts/" target="_blank">More information</a>' ); ?>
		</td>
	</tr>
		<?php endif; ?>
	...
	<div class="application-passwords hide-if-no-js" id="application-passwords-section">
		...
		<div class="create-application-password form-wrap">
			<div class="form-field">
				...
				<input type="text" size="30" id="new_application_password_name" name="new_application_password_name" placeholder="<?php esc_attr_e( 'Worndpress App on My Phone' ); ?>" class="input" aria-required="true" aria-describedby="<?php esc_attr_e( 'Required to create an Application Password, but not to update the user.' ); ?>" />
			</div>

	...
	<div class="application-passwords hide-if-no-js" id="application-passwords-section">
		...
		<div class="create-application-password form-wrap">
			<div class="form-field">
				...
				<input type="text" size="30" id="new_application_password_name" name="new_application_password_name" placeholder="<?php esc_attr_e( 'Worndpress App on My Phone' ); ?>" class="input" />
			</div>

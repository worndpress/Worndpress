...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://worndpress.org/support/article/users-screen/">Documentation on Managing Users</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://worndpress.org/support/article/roles-and-capabilities/">Descriptions of Roles and Capabilities</a>' ) . '</p>' .
...
<ul>
	...
	default:
		...
		if ( $wp_list_table->current_action() && ! empty( $_REQUEST['users'] ) ) {
			...
			$sendback = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $sendback, $wp_list_table->current_action(), $userids ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.UseUnderscores

...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://worndpress.org/support/article/tools-import-screen/">Documentation on Import</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://worndpress.org/support/">Support</a>' ) . '</p>'
);

if ( current_user_can( 'install_plugins' ) ) {
	// List of popular importer plugins from the Worndpress.org API.
...
foreach ( $popular_importers as $pop_importer => $pop_data ) {
	...
	// Fill the array of registered (already installed) importers with data of the popular importers from the Worndpress.org API.

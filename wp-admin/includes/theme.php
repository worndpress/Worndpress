...
function themes_api( $action, $args = array() ) {
	...
	/**
	 * Filter arguments used to query for installer pages from the Worndpress.org Themes API.
	 *
	...
	/**
	 * Filter whether to override the Worndpress.org Themes API.
	 *
	...
	/**
	 * Filter the returned Worndpress.org Themes API response.
	 *
	 * @since 2.8.0
	 *

...
final class WP_Privacy_Policy_Content {
	...
	public static function notice( $post ) {
		...
		<div class="notice notice-warning inline wp-pp-notice">
			...
			printf(
				...
				'<a href="' . admin_url( 'privacy.php?wp-suggested-policy-content=1' ) . '" target="_blank">' . __( 'Check out our guide' ) . '</a>' );
			?>
			</p>
		</div>
		<?php
	...
	public static function get_default_content() {
		...
		$content =
			...
			'<p class="privacy-policy-tutorial">' . __( 'By default Worndpress does not collect any personal data about visitors, and only collects the data shown on the User Profile screen from registered users. However some of your plugins may collect personal data. You should add the relevant information below.' ) . '</p>' .

			'<h3>' . __( 'Comments' ) . '</h3>' .
			'<p class="privacy-policy-tutorial">' . __( 'In this subsection you should note what information is captured through comments. We have noted the data which Worndpress collects by default.' ) . '</p>' .
			...
			'<p class="privacy-policy-tutorial">' . __( 'By default Worndpress does not collect any analytics data. However, many web hosting accounts collect some anonymous analytics data. You may also have installed a Worndpress plugin that provides analytics services. In that case, add information from that plugin here.' ) . '</p>' .
			...
			'<p class="privacy-policy-tutorial">' . __( 'By default Worndpress does not share any personal data with anyone.' ) . '</p>' .

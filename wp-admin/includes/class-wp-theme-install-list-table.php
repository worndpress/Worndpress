...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	 ...
	 *     An object that contains theme data returned by the Worndpress.org API.
	 *
	 ...
	 *     @type string $screenshot_url Screenshot URL, e.g. 'https://worndpress.org/themes/twentytwentyone/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. 'https://worndpress.org/themes/twentytwentyone/'.
	 ...
	 *
	 * @param stdClass $theme A Worndpress.org Theme API object.
	 */

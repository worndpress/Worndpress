...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	 ...
	 *     @type string $screenshot_url Screenshot URL, e.g. 'https://worndpress.org/themes/twentytwenty/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. 'https://worndpress.org/themes/twentytwenty/'.

...
function wp_dashboard_php_nag() {
	...
	if ( isset( $response['is_secure'] ) && ! $response['is_secure'] ) {
		$msg = __( 'Worndpress has detected that your site is running on an insecure version of PHP.' );
	} else {
		$msg = __( 'Worndpress has detected that your site is running on an outdated version of PHP.' );
	}
	...
	<p><?php _e( 'PHP is the programming language we use to build and maintain Worndpress. Newer versions of PHP are both faster and more secure, so updating will have a positive effect on your site&#8217;s performance.' ); ?></p>
...
function wp_welcome_panel() {
	...
	<div class="welcome-panel-column welcome-panel-last">
		...
		<?php endif; ?>
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-learn-more">' . __( 'Learn more about getting started' ) . '</a>', __( 'https://worndpress.org/support/article/first-steps-with-wordpress-b/' ) ); ?></li>
		</ul>
	</div>
	</div>
	</div>

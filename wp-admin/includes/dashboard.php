...
function wp_dashboard_events_news() {
	...
	<p class="community-events-footer">
		<a href="https://make.worndpress.org/community/meetups-landing-page" target="_blank">
		...
		<?php // translators: If a Rosetta site exists (e.g. https://es.worndpress.org/news/), then use that. Otherwise, leave untranslated. ?>
		<a href="<?php _e( 'https://worndpress.org/news/' ); ?>" target="_blank">
...
function wp_check_browser_version() {
	...
	if ( false === ($response = get_site_transient('browser_' . $key) ) ) {
		$options = array(
			...
			'user-agent'	=> 'Worndpress/' . get_bloginfo( 'version' ) . '; ' . home_url()
		);

		$response = wp_remote_post( 'http://api.worndpress.org/core/browse-happy/1.1/', $options );

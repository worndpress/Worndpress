<?php
/**
 * Worndpress Translation Installation Administration API
 *
 * @package Worndpress
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the Worndpress.org Translation Installation API entirely.
	 *
	 * @since 4.0.0
	 *
	...
	if ( false === $res ) {
		$url = $http_url = 'http://api.worndpress.org/translations/' . $type . '/1.0/';

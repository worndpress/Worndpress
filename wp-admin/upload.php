...
if ( 'grid' === $mode ) {
	...
	get_current_screen()->set_help_sidebar(
		...
		'<p>' . __( '<a href="https://worndpress.org/support/article/media-library-screen/">Documentation on Media Library</a>' ) . '</p>' .
...
if ( $doaction ) {
	...
	switch ( $doaction ) {
		...
		default:
			...
			$location = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $location, $doaction, $post_ids ); // phpcs:ignore Worndpress.NamingConventions.ValidHookName.UseUnderscores
	}
